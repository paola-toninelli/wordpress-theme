...
class My_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'my_recent_posts',
			'description'                 => __( 'Post recenti' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'post_recenti', __( 'post_recenti' ), $widget_ops );
		$this->alt_option_name = 'widget_post_recenti';
	}
